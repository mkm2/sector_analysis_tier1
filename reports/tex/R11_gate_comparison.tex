...
\paragraph{Every conserved quantity of the $X$ circuit is classical.} A
...
partition can see and nothing more.
...
under both gates (Corollary~\ref{cor:nofree}). Whatever fragmentation they show is
a property of a classical cellular automaton that a quantum engine happened to
compute. Four of R9's eight ``fragmentation in an open quantum system'' rules ---
