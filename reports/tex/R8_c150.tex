...
assumption-free engine to $N=22$ and the reduction to $N=32$ ---
$4.29\times10^{9}$ basis states, $21$~GB, $815$~s --- and the closed form is
exact at every $N$ computed.
...
The closed-form columns are exact for every $N$, computed or not.}
\label{tab:frontier}
\end{table}
